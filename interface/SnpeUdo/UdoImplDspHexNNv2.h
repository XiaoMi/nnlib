...
#ifndef SNPE_UDO_HEXNN_IMPL_H
#define SNPE_UDO_HEXNN_IMPL_H
#include <stdio.h>
 ...
 * 
 * @return error code, indicating success of query
 */
...
// Global infrastructure functions supported by HexNN v2  
 ...
 * function, and passing it (casted to void*). The Hexnn UDO library is expected
 * to casts it back to this following struct.
 *
 */
